...
//
//        double[] pfl = {10.0, 20.0, 30.0}; // Example profile
//        double[] A_db = new double[pfl.length];
//        long[] warnings = new long[pfl.length];
//
//        int result = itm.ITM_P2P_TLS_Ex(100.0, 50.0, pfl, 5, 301.0, 200000000.0, 0, 15.0, 0.005, 2, 50, 50, 50, A_db, warnings, interValues);
//
//        System.out.println("Result: " + result);
//        System.out.println("Attenuation: " + A_db[1]);
//        System.out.println("Warnings: " + warnings[1]);
